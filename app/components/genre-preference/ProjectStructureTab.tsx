...
import type { SourceProject, Universe } from './types';
...
interface ProjectStructureTabProps {
  ...
  setProjectType: (value: 'standalone' | 'trilogy' | 'series') => void;
  bookCount: number;
  setBookCount: (value: number) => void;

  // Universe
  useExistingUniverse: boolean;
  setUseExistingUniverse: (value: boolean) => void;
  universeSource: 'universe' | 'project';
  setUniverseSource: (value: 'universe' | 'project') => void;
  selectedUniverseId: string;
  setSelectedUniverseId: (value: string) => void;
  selectedSourceProjectId: string;
  setSelectedSourceProjectId: (value: string) => void;
  timeGapFromSource: string;
  setTimeGapFromSource: (value: string) => void;
  sourceProjects: SourceProject[];
  universes: Universe[];
  loadingUniverseData: boolean;
...
export function ProjectStructureTab(props: ProjectStructureTabProps): JSX.Element {
  const {
    projectType,
    setProjectType,
    bookCount,
