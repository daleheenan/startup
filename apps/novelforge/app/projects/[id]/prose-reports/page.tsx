...
export default function ProseReportsPage() {
  ...
  if (loading) {
    return (
      <DashboardLayout
        header={{
          title: 'Prose Quality Reports',
          subtitle: 'Analysing prose quality...',
        }}
        projectId={projectId}
      >
        <div style={{
  ...
  return (
    <DashboardLayout
      header={{
        title: 'Prose Quality Reports',
        subtitle: 'Automated analysis of prose quality across key metrics',
      }}
      projectId={projectId}
    >
