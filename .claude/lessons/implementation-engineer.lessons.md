# Lessons Learned: Implementation Engineer

<!--
This file stores accumulated lessons learned by the implementation-engineer agent (Carlos Mendez).
...
*No active lessons yet. Start recording lessons after implementation tasks.*
...
## Tag Categories for Implementation

Use consistent tags for searchability:

- **Complexity**: #multi-file #refactoring #migration #integration
- **Patterns**: #tdd #solid #clean-code #design-patterns
- **Tech**: #typescript #react #node #database #api
- **Quality**: #testing #error-handling #logging #documentation
- **Process**: #incremental #review-ready #backwards-compatible
