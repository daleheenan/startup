# Lessons Learned: Schema Agent

<!--
This file stores accumulated lessons learned by the schema-agent agent.
...
- **Top themes**: #database #schema #sqlite #migrations #indexing
...
**Context**: Establishing baseline patterns for database schema design

**What Worked Well**:
- Foreign keys with `PRAGMA foreign_keys = ON`
- Indexes on frequently queried columns
- Dates as ISO TEXT (YYYY-MM-DD) for SQLite compatibility

**What Didn't Work**:
- N/A (initialization)

**Lesson**: Always enable foreign key enforcement, create indexes strategically based on query patterns, and use consistent date formats across the schema.

**Application Score**: 0

**Tags**: #database #schema #sqlite #initialization
...
- **Tech**: #sqlite #postgresql #mysql #sql
- **Process**: #migrations #seeds #versioning
- **Patterns**: #normalization #indexing #constraints #triggers
- **Problems**: #performance #integrity #deadlocks #migrations
- **Tools**: #drizzle #prisma #knex #sequelize
