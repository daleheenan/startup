# Lessons Learned: Service Agent

<!--
This file stores accumulated lessons learned by the service-agent agent.
...
- **Top themes**: #tdd #business-logic #services #testing
...
**Context**: Establishing baseline patterns for TDD service development

**What Worked Well**:
- Red-Green-Refactor TDD cycle
- Writing test file FIRST before implementation
- Penny precision for financial calculations: `Math.round(amount * 100) / 100`

**What Didn't Work**:
- N/A (initialization)

**Lesson**: Always write the failing test first, implement the minimum code to pass, then refactor. This ensures comprehensive test coverage and catches edge cases early.

**Application Score**: 0

**Tags**: #tdd #business-logic #testing #initialization
...
- **Tech**: #typescript #javascript #node
- **Process**: #tdd #red-green-refactor #coverage
- **Patterns**: #service-layer #dependency-injection #error-handling
- **Problems**: #edge-cases #precision #concurrency #transactions
- **Tools**: #vitest #jest #mocha #sinon
