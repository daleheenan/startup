# Lessons Learned: Sprint Retrospective Facilitator

<!--
This file stores accumulated lessons learned by the sprint-retrospective-facilitator agent (Dr. Amara Osei).
...
*No active lessons yet. Start recording lessons after facilitating retrospectives.*
...
## Tag Categories for Retrospectives

Use consistent tags for searchability:

- **Themes**: #communication #handoffs #tooling #process #quality
- **Outcomes**: #action-item #improvement #celebration #learning
- **Patterns**: #recurring #one-time #systemic #individual
- **Agents**: #cross-agent #shared-learning #agent-specific
