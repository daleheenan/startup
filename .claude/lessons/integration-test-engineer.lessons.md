# Lessons Learned: Integration Test Engineer

<!--
This file stores accumulated lessons learned by the integration-test-engineer agent.
...
- **Tech**: #typescript #database #sql #integration #api #testing
- **Process**: #debugging #schema #validation #migrations
- **Patterns**: #error-handling #transactions #constraints #foreign-keys
- **Problems**: #column-mismatch #sql-errors #schema-drift #data-integrity
- **Tools**: #vitest #supertest #better-sqlite3 #drizzle
