# Lessons Learned: Prose Editor

<!--
This file stores accumulated lessons learned by the prose-editor agent.
...
- **Tech**: #prose #fiction #editing #style #voice
- **Process**: #tightening #cutting #rewriting #flow
- **Patterns**: #filter-words #qualifiers #show-dont-tell #subtext
- **Problems**: #redundancy #overwriting #pacing #rhythm
- **Tools**: #word-count #readability #consistency
