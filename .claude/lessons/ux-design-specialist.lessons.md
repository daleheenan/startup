# Lessons Learned: UX Design Specialist

<!--
This file stores accumulated lessons learned by the ux-design-specialist agent (Maya Johnson).
...
*No active lessons yet. Start recording lessons after UX design tasks.*
...
## Tag Categories for UX Design

Use consistent tags for searchability:

- **Accessibility**: #wcag #aria #contrast #keyboard #screen-reader
- **Usability**: #navigation #feedback #error-handling #loading-states
- **Visual**: #typography #color #spacing #hierarchy #responsive
- **Interaction**: #forms #buttons #modals #animations #gestures
- **Research**: #user-testing #heuristics #personas #journey-maps
