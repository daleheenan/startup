# Lessons Learned: Test Architect

<!--
This file stores accumulated lessons learned by the test-architect agent (Dr. Sarah Okonkwo).
...
*No active lessons yet. Start recording lessons after designing test strategies.*
...
## Tag Categories for Test Architecture

Use consistent tags for searchability:

- **Strategy**: #test-pyramid #coverage #risk-based #shift-left
- **Types**: #unit #integration #e2e #contract #performance
- **Patterns**: #arrange-act-assert #given-when-then #test-doubles
- **Tools**: #jest #vitest #playwright #supertest #msw
- **Quality**: #flaky-tests #deterministic #fast #maintainable
