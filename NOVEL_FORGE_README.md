...
The backend server will start on port 3001 and automatically begin the queue worker.
...
│   │       ├── chapter-orchestrator.service.ts
│   │       ├── character-generator.ts
│   │       ├── claude.service.ts
│   │       ├── cross-book-continuity.service.ts    # Sprint 8
│   │       ├── series-bible-generator.service.ts   # Sprint 8
│   │       ├── book-transition.service.ts          # Sprint 8
│   │       └── ...
│   └── package.json
...
NovelForge was developed across 8 sprints:

| Sprint | Focus | Status |
|--------|-------|--------|
| Sprint 1 | Foundation & Infrastructure | ✅ Complete |
| Sprint 2 | Idea Generation | ✅ Complete |
| Sprint 3 | World & Characters | ✅ Complete |
| Sprint 4 | Outline Generation | ✅ Complete |
| Sprint 5 | Chapter Generation | ✅ Complete |
| Sprint 6 | Editing Agents | ✅ Complete |
| Sprint 7 | Export & Dashboard | ✅ Complete |
| Sprint 8 | Trilogy Support | ✅ Complete |
