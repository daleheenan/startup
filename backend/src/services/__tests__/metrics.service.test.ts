  ...
  describe('formatMetrics', () => {
    it('should format token counts correctly', () => {
      const metrics: ProjectMetrics = {
        ...
        total_cost_usd: 100,
        total_cost_gbp: 79,
        chapter_input_tokens: 10000,
        chapter_output_tokens: 200000,
        chapter_cost_usd: 8.0,
        chapter_cost_gbp: 6.32,
        total_ai_cost_usd: 150,
        total_ai_cost_gbp: 118.5,
        total_ai_requests: 25,
        total_chapters: 10,
    ...
    it('should format costs correctly', () => {
      const metrics: ProjectMetrics = {
        ...
        chapter_input_tokens: 5000,
        chapter_output_tokens: 10000,
        chapter_cost_usd: 0.83,
        chapter_cost_gbp: 0.65,
        total_ai_cost_usd: 20,
        total_ai_cost_gbp: 15.8,
    ...
    it('should return formatted metrics for all projects', () => {
      const mockMetrics: ProjectMetrics[] = [
        ...
        },
        {
          ...
          total_cost_usd: 8.25,
          total_cost_gbp: 6.52,
          chapter_input_tokens: 2500,
          chapter_output_tokens: 5000,
          chapter_cost_usd: 0.41,
          chapter_cost_gbp: 0.33,
          total_ai_cost_usd: 10,
          total_ai_cost_gbp: 7.9,
          total_ai_requests: 5,
          total_chapters: 5,
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle very large token counts', () => {
      const metrics: ProjectMetrics = {
        ...
        chapter_input_tokens: 15000000,
        chapter_output_tokens: 25000000,
        chapter_cost_usd: 2000,
        chapter_cost_gbp: 1580,
        total_ai_cost_usd: 25000,
        total_ai_cost_gbp: 19750,
        total_ai_requests: 1000,
        total_chapters: 100,
    ...
    it('should handle small token counts (under 1000)', () => {
      const metrics: ProjectMetrics = {
        ...
        total_cost_usd: 0.05,
        total_cost_gbp: 0.04,
        chapter_input_tokens: 45,
        chapter_output_tokens: 78,
        chapter_cost_usd: 0.005,
        chapter_cost_gbp: 0.004,
        total_ai_cost_usd: 0.1,
        total_ai_cost_gbp: 0.079,
        total_ai_requests: 2,
        total_chapters: 1,
